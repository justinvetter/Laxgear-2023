...
// File paths
const files = {
	scssPath: 'src/theme/**/*.scss',
	jsPath: 'app/js/**/*.js',
};

// Sass task: compiles the style.scss file into style.css
function scssTask() {
	return src('src/theme/main.scss', { sourcemaps: true }) // set source and turn on sourcemaps
...
function bsWatchTask() {
	...
	watch(
		[files.scssPath],
		{ interval: 1000, usePolling: true }, //Makes docker work
		series(parallel(scssTask), cacheBustTask, browserSyncReload)
	);
}
